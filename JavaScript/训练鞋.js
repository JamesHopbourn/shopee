...
setTimeout(function(){
	document.evaluate("/html/body/div[1]/div[2]/div/div/div/div[3]/div[1]/div[1]/div[2]/div[3]/ul[3]/li[3]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click()
}, 500);
