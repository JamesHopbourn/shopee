...
brand_list = requests.get("https://seller.shopee.cn/api/v3/mtsku/get_mtsku_brand_list?category_ids=101298&brand_status=1&cursor=0&limit=100&cnsc_shop_id=821694597",
	cookies={
